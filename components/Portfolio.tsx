...
const Portfolio: React.FC<PortfolioProps> = ({ content }) => {
  ...
  return (
    <section className="py-32 bg-white border-t border-neutral-100 relative" id="portfolio">
      {/* 
          ...
          <div className="flex gap-8 mt-6 md:mt-0">
            {['marketing', 'design'].map((tab) => (
                ...
                onClick={() => {
                    ...
                    // Update URL hash without jumping (optional, but good for linking)
            ...
            <div className="relative bg-white w-full max-w-6xl h-full md:h-[90vh] shadow-2xl flex flex-col overflow-hidden border border-neutral-200 animate-in fade-in zoom-in-95 duration-300">
              ...
              <div className="overflow-y-auto h-full">
                {selectedItem.gallery ? (
                    // DESIGN MODE
                    <div className="flex flex-col">
                        <div className="p-8 md:p-12 border-b border-neutral-100 bg-white sticky top-0 z-40">
                    ...
                    <div className="flex flex-col lg:flex-row min-h-full">
                        <div className="w-full lg:w-1/2 bg-neutral-100 relative min-h-[400px] lg:min-h-full border-r border-neutral-100">
                            <img 
                        ...
                        <div className="w-full lg:w-1/2 p-10 lg:p-16 bg-white overflow-y-auto">
                            <div className="mb-12 border-b border-black pb-8">
                                ...
                                <h3 className="text-3xl lg:text-4xl font-serif text-black mb-6 leading-tight">{selectedItem.title}</h3>
